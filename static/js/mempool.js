!(function (e) {
      ...
      e.exports = function (e) {
        return new Promise(function (t, n) {
          ...
          if (
            ...
            var b =
              (e.withCredentials || _(p)) && e.xsrfCookieName
    ...
    k = function (e) {
      ...
      return e
        ? (l.forEach(e.split('\n'), function (e) {
            if (
              ((r = e.indexOf(':')),
              (t = l.trim(e.substr(0, r)).toLowerCase()),
              (n = l.trim(e.substr(r + 1))),
              t)
            ) {
  ...
  function U() {
    L &&
      R &&
      ((L = !1), R.length ? (C = R.concat(C)) : (N = -1), C.length && q())
  }
  function q() {
    if (!L) {
      var e = M(U)
      ...
      return (
        ...
        (e.adapter || J.adapter)(e).then(
          function (t) {
            return (
              W(e),
              (t.data = G.call(e, t.data, t.headers, e.transformResponse)),
              t
            )
          },
          function (t) {
            ...
            return ve(this, function (n) {
              switch (n.label) {
                case 0:
                  return [
                    4,
                    e.get('/block/' + t.hash + '/txs/' + t.start_index)
                  ]
                case 1:
                  return [2, n.sent().data]
              }
    ...
    (nt.useMarkets = function (e) {
      return {
        getCurrencies: function (t) {
          return (
            void 0 === t &&
              (t = {basecurrency: 'BTC', type: 'all', format: 'jsonpretty'}),
          ...
          return at(void 0, void 0, void 0, function () {
            ...
            return ut(this, function (r) {
              switch (r.label) {
                case 0:
                  return (
                    (n = !0 === t.is_mempool ? '/mempool' : '/chain'),
                    [4, e.get('/asset/' + t.asset_id + '/txs' + n)]
                  )
                case 1:
          ...
          return at(void 0, void 0, void 0, function () {
            ...
            return ut(this, function (r) {
              switch (r.label) {
                case 0:
                  return (
                    (n = !0 === t.decimal ? '/decimal' : ''),
                    [4, e.get('/asset/' + t.asset_id + '/supply' + n)]
                  )
                case 1:
                  return [2, r.sent().data]
              }
