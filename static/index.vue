              ...
              <q-select
                ...
                :hint="
                  ...
                  fiatRates[formDialogCharge.data.currency]
                    ? `Currently 1 ${formDialogCharge.data.currency} = ${fiatRates[formDialogCharge.data.currency]} sat`
                    : '')
                "
            ...
            <q-item tag="label" v-ripple v-if="!formDialogCharge.data.zeroconf">
              ...
              <q-item-section>
                ...
                <q-item-label caption>
                  ...
                  once the onchain payment is detected (0-conf). Unlike 0-conf
                  it will wait for the onchain to be confirmed to send a webhook
                  with charge is paid.
                </q-item-label>
              </q-item-section>
            </q-item>
